...
* Django
* [django-channels](https://channels.readthedocs.io/en/latest/) - for providing live feedback to events via websockets
...
Audio services:
* [Amazon Polly](https://aws.amazon.com/polly/) - provides text-to-speech
  * [Python SDK Docs](https://docs.aws.amazon.com/boto3/latest/reference/services/polly.html)
* [Amazon Transcribe](https://aws.amazon.com/transcribe/) - provides speech transcription
